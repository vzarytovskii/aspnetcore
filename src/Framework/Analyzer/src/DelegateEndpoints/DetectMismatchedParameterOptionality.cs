...
public partial class DelegateEndpointAnalyzer : DiagnosticAnalyzer
{
        ...
        IMethodSymbol methodSymbol)
    {
        ...
        {
            var isOptional = parameter.IsOptional || parameter.NullableAnnotation == NullableAnnotation.Annotated;
    ...
    private static IDictionary<string, RouteParameter> GetParametersFromRoute(string routeTemplate)
    {
        ...
        while (enumerator.MoveNext())
        {
            result.Add(
                ...
                new RouteParameter(enumerator.CurrentName.ToString(), enumerator.CurrentQualifiers.IndexOf('?') > -1));
        }
        return result;
    }
